...
class Tank(pg.sprite.Sprite):
    ...
    def move(self, direction, rotation):
        ...
        if self.rotation >= 0:
            ...
            self.gunpos = (self.rect.centerx, self.rect.top - 5)
            x = 0
            y = -1
        if self.rotation >= 45:
            self.image = self.images[1]
            self.gunpos = (self.rect.right + 5, self.rect.top - 5)
            x = 1
            y = -1
        if self.rotation >= 90:
            self.image = self.images[2]
            self.gunpos = (self.rect.right + 10, self.rect.centery)
            x = 1
            y = 0
        if self.rotation >= 135:
            self.image = self.images[3]
            self.gunpos = (self.rect.right + 5, self.rect.bottom + 5)
            x = 1
            y = 1
        if self.rotation >= 180:
            self.image = self.images[4]
            self.gunpos = (self.rect.centerx, self.rect.bottom + 5)
            x = 0
            y = 1
        if self.rotation >= 225:
            self.image = self.images[5]
            self.gunpos = (self.rect.left - 5, self.rect.bottom + 5)
            x = -1
            y = 1
        if self.rotation >= 270:
            self.image = self.images[6]
            self.gunpos = (self.rect.left - 10, self.rect.centery)
            x = -1
            y = 0
        if self.rotation >= 315:
            self.image = self.images[7]
            self.gunpos = (self.rect.left - 5, self.rect.top - 5)
            x = -1
            y = -1
